    ...
    return (
        <div>
            <div className="CustomComment" onScroll={() => {props.onScroll && props.onScroll() }}>
                ...
                <div className="commentpanelviewContentlist">
                    <div className="title">
                        <span className="text">Comments</span>
                        {/* <button onClick={() => props.customToolbarRef.current?.toggleSidebarBtn(false); } className="closepanel">
                    ...
                    <div className="list" id="commentAccordionExtension">{comments}</div>
                </div>
            </div>
        </div>
    )
